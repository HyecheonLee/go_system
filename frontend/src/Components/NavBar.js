...
export function Navbar({validjwt, loading, modalShowing, setModalShowing, setModalDisplay, setNavDropMenuPosX, setNavDropMenuType}) {
  ...
  return (
    <StyledNavbar id="Navbar" svgIcon="/icons/16px/code.svg" svgUserIcon="/icons/16px/user.svg">
      <div id="styled-navbar-content">
        <div id="styled-navbar-content-icon"/>
        <div id="styled-navbar-content-title">Foo Demy</div>

        <Button text="Resources" btype="icon-btn" svgIcon="/icons/20px/box.svg" onMouseEnter={(e) => {
          e.stopPropagation();
        ...
        {loading === false && validjwt !== true && (
          <>
            <Button text="Log In" btype="white" onClick={(e) => {
              setModalShowing(true);
              setModalDisplay('login');
            }}/>
            <Button text="Sign Up" btype="red" onClick={(e) => {
              setModalShowing(true);
        ...
        {loading === false && validjwt === true && (
          <div id="styled-navbar-profile-icon" onMouseEnter={(e) => {
            e.stopPropagation();
            getNavPosition(e, 'profile', true);
          }}/>
        )}
      </div>
    </StyledNavbar>
