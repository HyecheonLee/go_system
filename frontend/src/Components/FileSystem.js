              ...
              {fsn['children'].length > 0 && fsn['children'].map((fsnc, index) => (
                <>
                  <div className="file-system-browser-level-two-node">
                    <span
                      className={fsn['children'][index]['info']['is_dir'] ? `file-system-browser-level-two-node-icon directory` : `file-system-browser-level-two-node-icon`}></span>
                    ...
                    {fsnc['children'].length > 0 && fsnc['children'].map((fsncc, index) => (
                      <>
                        <div className="file-system-browser-level-three-node">
                          <span
                            className={fsnc['children'][index]['info']['is_dir'] ? `file-system-browser-level-three-node-icon directory` : `file-system-browser-level-three-node-icon`}></span>
                        ...
                        <div className="file-system-browser-level-four-nodes">
                          {fsncc['children'].length > 0 && fsncc['children'].map((fsnccc, index) => (
                            <div className="file-system-browser-level-four-node">
                              <span
                                className={fsncc['children'][index]['info']['is_dir'] ? `file-system-browser-level-four-node-icon directory` : `file-system-browser-level-four-node-icon`}></span>
